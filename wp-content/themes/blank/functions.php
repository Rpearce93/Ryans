...
function blank_scripts() {
	...
	wp_enqueue_style( 'blank-style', get_template_directory_uri() . '/dist/main.css', array(), true  );

	wp_enqueue_script( 'blank-jquery', get_template_directory_uri() . '/js/jquery.min.js', array(), true );

	wp_enqueue_script( 'blank-particles', get_template_directory_uri() . '/js/particles.min.js', array(), true );

	wp_enqueue_script( 'blank-mainscript', get_template_directory_uri() . '/dist/main.js', array(), true );
